        ...
        var viewport = new Ext.Viewport({
           ...
           { region: 'west',
            ...
            new Ext.TabPanel({
                ...
                items: [{ id: 'tab0',
                    html: '<iframe id="frame1" src="3dRes/startpage/HTMLPage.htm" frameborder="0" width="100%" height="100%"></iframe> ',
                    title: '默认首页',
                    closable: false}]
                })]
            ...
            //alert(1);
            Ext.getCmp('tabs').get('tab0').show();   //默认页显示

            $(function() {
                //get_ajax("name_search3d", "nameSearch");
                //get_ajax("short_path3d", "shortPath");
                //        get_ajax("startpage", "Start");
            });
        }
        catch (e) {
            alert(e.description);
